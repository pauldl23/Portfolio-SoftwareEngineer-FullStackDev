...
const skills = [
  ...
  { id: '02', name: 'C# / C++', icon: '6_vector.svg', category: 'Enterprise Solutions' },
  ...
  { id: '12', name: 'JUPYTER', icon: 'jupyter.png', category: 'Data Science Notebook' },
  { id: '13', name: 'GITHUB', icon: 'github.png', category: 'Developer team collaboration' },
  { id: '14', name: 'AFTER EFFECTS', icon: 'ae.png', category: 'Motion Graphics' },
  { id: '15', name: 'PREMIERE', icon: 'pre.png', category: 'Video Editing' },
];
