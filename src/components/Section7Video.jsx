...
const projects = [
  ...
  },
  {
    ...
    description: 'Created and edited high-impact short-form videos for LinkedIn/ Social Media, integrating motion graphics, captions, and engaging visual elements to improve audience engagement and content performance.',
    video: 'https://drive.google.com/open?id=1gXDJBuRbiSfkMshrGlKKJnHXta3UmFUd&usp=drive_fs',
    link: '#',
    hasVideo: true,
  },
  {
