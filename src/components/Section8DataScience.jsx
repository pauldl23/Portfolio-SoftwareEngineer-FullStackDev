...
const projects = [
  ...
  },
  {
    ...
    titleAccent: 'Defect Classifier',
    tags: ['Python', 'Computer Vision', 'Deep Learning'],
    description: 'A structural integrity verification tool using convolutional neural networks. Deployed in a manufacturing pipeline to automatically identify micro-defects in real-time video feeds with 99.2% accuracy.',
    image: '',
    link: '#',
    hasImage: false,
  },
